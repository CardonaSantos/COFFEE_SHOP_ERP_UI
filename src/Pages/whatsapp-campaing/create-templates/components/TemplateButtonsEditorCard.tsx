      ...
      <CardHeader className="pb-3 pt-4 px-4">
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center gap-2 text-sm font-medium">
            ...
            Botones <span className="text-xs text-muted-foreground font-normal">(opcional, máx. 3)</span>
          </CardTitle>
          <Switch
            ...
            <div key={i} className="space-y-2">
              ...
              <div className="grid gap-2 sm:grid-cols-2">
                ...
                <div className="space-y-1">
                  ...
                  <Select
                    value={btn.type}
                    onValueChange={(v) => onTypeChange(i, v as WhatsappTemplateButtonType)}
                  >
                ...
                <div className="space-y-1">
                  ...
                  {errors[`button_${i}_text`] && (
                    <p className="text-xs text-destructive">{errors[`button_${i}_text`]}</p>
                  )}
                </div>
              </div>
              ...
              {btn.type === "PHONE_NUMBER" && (
                <div className="space-y-1">
                  ...
                  {errors[`button_${i}_phone`] && (
                    <p className="text-xs text-destructive">{errors[`button_${i}_phone`]}</p>
                  )}
                </div>
              )}
            </div>
